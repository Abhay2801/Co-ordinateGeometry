<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CalculateSection.aspx.cs" Inherits="GeometryProject2.CalculateSection" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="header">
            <h2 class="auto-style4">Calculate Section</h2>
        </div>
        ...
        <div class="input-container">
            <asp:Label ID="Label5" runat="server" Text="m" Width="50px"></asp:Label>
            <asp:TextBox ID="txtM" runat="server" CssClass="form-control" placeholder="Enter m"></asp:TextBox>

            <asp:Label ID="Label6" runat="server" Text="n" Width="50px"></asp:Label>
            <asp:TextBox ID="txtN" runat="server" CssClass="form-control" placeholder="Enter n"></asp:TextBox>
        ...
        <div class="button-container">
            <asp:Button ID="btnCalculateSection" runat="server" Text="Calculate Section" OnClick="BtnCalculateSection_Click" BorderColor="Blue" BorderStyle="Ridge" BorderWidth="5px" Height="50px" Width="260px" />
        </div>

        <br />

        <div class="result-container">
            <asp:Label ID="lblResultSection" runat="server" EnableViewState="False" style="font-size:20px" BorderStyle="None" Height="40px" Width="550px"></asp:Label>
        </div>
